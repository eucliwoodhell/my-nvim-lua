...
vim.api.nvim_create_user_command("FormatSync", ":lua vim.lsp.buf.format_sync()", { nargs = 0 })
vim.api.nvim_create_user_command("FormatSyncSeq", ":lua vim.lsp.buf.format_seq_sync()", { nargs = 0 })
